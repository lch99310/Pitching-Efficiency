...
Greg Maddux 把「用最省的方式製造出局」練成了一門藝術。巔峰時期，他常常投完一場完投、用球數還停在 80 幾球——幾乎看不到三振，就靠誘導軟弱擊球、一局一局快速解決——這種本事和他的名字緊緊綁在一起，以至於「不到 100 球的完投完封」如今直接被叫做一場 *Maddux*。

我們一直很欣賞這種投球。但我們始終沒有一個**數字**來描述它——一個能乾淨地說出「投手把力氣轉換成出局有多有效率」的量。ERA 算的是回來得分的跑者；三振率算的是他讓打者揮空的次數；但兩者都抓不太到 Maddux 最擅長的那件事。

這篇文章談的，就是一個試著做到這件事、而且你在腦中就能算出來的指標。它叫 **Outs Per Effort（OPE）**，建立在一個念頭上：*投手的工作是「買」出局，而我們可以衡量他買得多便宜。* 本文會從這一句話把 OPE 建出來，再讓它通過四道測驗——它對每種投手都**公平**嗎？它**準**嗎？它**和這項運動既有的『最佳投手』認定一致**嗎？它能**跨越生涯與年代**站得住嗎？而且一路上它還做了既有指標做不到的一件事：終於能用一個數字描述像 Maddux 這樣的投手。若都通過，我們就得到一個和 ERA 一樣簡單、視野卻更寬的指標。
...
**在 ERA 眼裡他們幾乎是雙胞胎。** OPE 卻在兩人間拉開一整級：Glasnow 用壓倒性球威解決打者、幾乎不讓壘包；Morton 則為了同樣的 ERA 投得更辛苦。一樣的結果、不同的過程——而讀出這個差別，正是 OPE 想補上的那個維度。

## 測驗三：OPE 和「最佳投手」的認定一致嗎？

一個全新的指標要贏得信任，靠的不是推翻專家，而是**認出他們認出的偉大**。我把 2023–2025 每位賽揚得主，放回他們**自己聯盟**的 OPE 排名裡：

![OPE 與賽揚票選一致](charts/09_cy_young.png)

結果令人安心：每一位得主，都是他所屬聯盟裡最有效率的先發之一——多數在 90 百分位以上，而且**全部遠高於平均**。當記者頒出獎項時，OPE 也在一旁點頭。

OPE 真正的價值，在於它加入的是一個**獨立**的視角、而非重複的視角——而近年最接近的一場賽揚之爭，正好說明了這點。2012 年美聯獎項，在兩個世代級的球季之間難分軒輊：David Price 與 Justin Verlander。

| 2012 AL | ERA | IP | K | WHIP | OPE |
|---|:--:|:--:|:--:|:--:|:--:|
| David Price（獲獎） | 2.56 | 211.0 | 205 | 1.10 | **14.69** |
| Justin Verlander | 2.64 | 238.1 | 239 | 1.06 | **14.47** |

三個好指標，對同一對頂尖投手給出三個角度。ERA 以極小差距偏向 Price；WAR 偏向 Verlander，獎勵他多投的 27 局與多拿的 34 次三振；而 OPE——一個純粹的效率比率——同樣站在 Price 這邊：一球一球、一壘一壘地看，他稍微更省。它們沒有誰「對」，因為它們回答的是不同的問題：WAR 問的是累積了**多少價值**，OPE 問的是**投得多有效率**。**OPE 不取代 ERA 或 WAR——它只是拉一張椅子，替這張桌子補上「效率」這個座位**，而這一次，它剛好和票選的結果一致。
